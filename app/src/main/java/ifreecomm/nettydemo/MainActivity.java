...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, NettyListener {
    ...
    private NettyClient mNettyClient;//,mNettyClient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // mNettyClient02=new NettyClient();
    }
    ...
    private void findViews() {
        ...
        mConnect02 = findViewById(R.id.connect02);
        mSendBtn = findViewById(R.id.send_btn);
        mClearLog = findViewById(R.id.clear_log);
        mConnect02.setOnClickListener(this);
...
//        }
        mNettyClient.start(Const.HOST, Const.TCP_PORT);
    }

    private void connect02() {
        Log.d(TAG, "connect");
        mNettyClient.start02(Const.HOST02, Const.TCP_PORT02);
    }
...
//        logRece(hexFun3);
    ...
    public void gotoSocket(View view) {
